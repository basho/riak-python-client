...
MESSAGE_CLASSES = {
    ...
    MSG_CODE_GET_CLIENT_ID_RESP: riak.pb.riak_pb2.RpbGetClientIdResp,
    MSG_CODE_SET_CLIENT_ID_REQ: riak.pb.riak_pb2.RpbSetClientIdReq,
    ...
    MSG_CODE_GET_REQ: riak.pb.riak_pb2.RpbGetReq,
    MSG_CODE_GET_RESP: riak.pb.riak_pb2.RpbGetResp,
    MSG_CODE_PUT_REQ: riak.pb.riak_pb2.RpbPutReq,
    MSG_CODE_PUT_RESP: riak.pb.riak_pb2.RpbPutResp,
    MSG_CODE_DEL_REQ: riak.pb.riak_pb2.RpbDelReq,
    MSG_CODE_DEL_RESP: None,
    MSG_CODE_LIST_BUCKETS_REQ: riak.pb.riak_pb2.RpbListBucketsReq,
    MSG_CODE_LIST_BUCKETS_RESP: riak.pb.riak_pb2.RpbListBucketsResp,
    MSG_CODE_LIST_KEYS_REQ: riak.pb.riak_pb2.RpbListKeysReq,
    MSG_CODE_LIST_KEYS_RESP: riak.pb.riak_pb2.RpbListKeysResp,
    ...
    MSG_CODE_MAP_RED_REQ: riak.pb.riak_pb2.RpbMapRedReq,
    MSG_CODE_MAP_RED_RESP: riak.pb.riak_pb2.RpbMapRedResp,
    MSG_CODE_INDEX_REQ: riak.pb.riak_pb2.RpbIndexReq,
    MSG_CODE_INDEX_RESP: riak.pb.riak_pb2.RpbIndexResp,
    MSG_CODE_SEARCH_QUERY_REQ: riak.pb.riak_pb2.RpbSearchQueryReq,
    MSG_CODE_SEARCH_QUERY_RESP: riak.pb.riak_pb2.RpbSearchQueryResp,
    ...
    riak.pb.riak_pb2.RpbGetBucketKeyPreflistReq,
    MSG_CODE_GET_BUCKET_KEY_PREFLIST_RESP:
    riak.pb.riak_pb2.RpbGetBucketKeyPreflistResp,
    MSG_CODE_CS_BUCKET_REQ: riak.pb.riak_pb2.RpbCSBucketReq,
    MSG_CODE_CS_BUCKET_RESP: riak.pb.riak_pb2.RpbCSBucketResp,
    MSG_CODE_INDEX_BODY_RESP: riak.pb.riak_pb2.RpbIndexBodyResp,
    MSG_CODE_COUNTER_UPDATE_REQ: riak.pb.riak_pb2.RpbCounterUpdateReq,
    MSG_CODE_COUNTER_UPDATE_RESP: riak.pb.riak_pb2.RpbCounterUpdateResp,
    MSG_CODE_COUNTER_GET_REQ: riak.pb.riak_pb2.RpbCounterGetReq,
    MSG_CODE_COUNTER_GET_RESP: riak.pb.riak_pb2.RpbCounterGetResp,
    MSG_CODE_YOKOZUNA_INDEX_GET_REQ:
    riak.pb.riak_pb2.RpbYokozunaIndexGetReq,
    MSG_CODE_YOKOZUNA_INDEX_GET_RESP:
    riak.pb.riak_pb2.RpbYokozunaIndexGetResp,
    MSG_CODE_YOKOZUNA_INDEX_PUT_REQ:
    riak.pb.riak_pb2.RpbYokozunaIndexPutReq,
    MSG_CODE_YOKOZUNA_INDEX_DELETE_REQ:
    riak.pb.riak_pb2.RpbYokozunaIndexDeleteReq,
    MSG_CODE_YOKOZUNA_SCHEMA_GET_REQ:
    riak.pb.riak_pb2.RpbYokozunaSchemaGetReq,
    MSG_CODE_YOKOZUNA_SCHEMA_GET_RESP:
    riak.pb.riak_pb2.RpbYokozunaSchemaGetResp,
    MSG_CODE_YOKOZUNA_SCHEMA_PUT_REQ:
    riak.pb.riak_pb2.RpbYokozunaSchemaPutReq,
    MSG_CODE_COVERAGE_REQ: riak.pb.riak_pb2.RpbCoverageReq,
    MSG_CODE_COVERAGE_RESP: riak.pb.riak_pb2.RpbCoverageResp,
    MSG_CODE_DT_FETCH_REQ: riak.pb.riak_pb2.DtFetchReq,
    MSG_CODE_DT_FETCH_RESP: riak.pb.riak_pb2.DtFetchResp,
    MSG_CODE_DT_UPDATE_REQ: riak.pb.riak_pb2.DtUpdateReq,
    MSG_CODE_DT_UPDATE_RESP: riak.pb.riak_pb2.DtUpdateResp,
    MSG_CODE_TS_QUERY_REQ: riak.pb.riak_pb2.TsQueryReq,
    MSG_CODE_TS_QUERY_RESP: riak.pb.riak_pb2.TsQueryResp,
    MSG_CODE_TS_PUT_REQ: riak.pb.riak_pb2.TsPutReq,
    MSG_CODE_TS_PUT_RESP: riak.pb.riak_pb2.TsPutResp,
    MSG_CODE_TS_DEL_REQ: riak.pb.riak_pb2.TsDelReq,
    MSG_CODE_TS_DEL_RESP: riak.pb.riak_pb2.TsDelResp,
    MSG_CODE_TS_GET_REQ: riak.pb.riak_pb2.TsGetReq,
    MSG_CODE_TS_GET_RESP: riak.pb.riak_pb2.TsGetResp,
    MSG_CODE_TS_LIST_KEYS_REQ: riak.pb.riak_pb2.TsListKeysReq,
    MSG_CODE_TS_LIST_KEYS_RESP: riak.pb.riak_pb2.TsListKeysResp,
