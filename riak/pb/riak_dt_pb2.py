...
class MapField(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _MAPFIELD

  # @@protoc_insertion_point(class_scope:MapField)

class MapEntry(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _MAPENTRY

  # @@protoc_insertion_point(class_scope:MapEntry)

class DtFetchReq(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _DTFETCHREQ

  # @@protoc_insertion_point(class_scope:DtFetchReq)

class DtValue(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _DTVALUE

  # @@protoc_insertion_point(class_scope:DtValue)

class DtFetchResp(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _DTFETCHRESP

  # @@protoc_insertion_point(class_scope:DtFetchResp)

class CounterOp(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _COUNTEROP

  # @@protoc_insertion_point(class_scope:CounterOp)

class SetOp(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _SETOP

  # @@protoc_insertion_point(class_scope:SetOp)

class GSetOp(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _GSETOP

  # @@protoc_insertion_point(class_scope:GSetOp)

class HllOp(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _HLLOP

  # @@protoc_insertion_point(class_scope:HllOp)

class MapUpdate(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _MAPUPDATE

  # @@protoc_insertion_point(class_scope:MapUpdate)

class MapOp(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _MAPOP

  # @@protoc_insertion_point(class_scope:MapOp)

class DtOp(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _DTOP

  # @@protoc_insertion_point(class_scope:DtOp)

class DtUpdateReq(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _DTUPDATEREQ

  # @@protoc_insertion_point(class_scope:DtUpdateReq)

class DtUpdateResp(_message.Message, metaclass=_reflection.GeneratedProtocolMessageType):
