...
class RiakObject(object):
    ...
    def __init__(self, client, bucket, key=None):
        ...
        :type bucket: :py:class:`RiakBucket <riak.bucket.RiakBucket>`
    ...
    def reload(self, r=None, pr=None, timeout=None, basic_quorum=None,
        ...
        .. note:: Even if the key is not found in Riak, this will
           return a :py:class:`RiakObject`. Check the :attr:`exists`
    ...
    def add(self, *args):
        ...
        :rtype: :py:class:`~riak.mapreduce.RiakMapReduce`
        """
