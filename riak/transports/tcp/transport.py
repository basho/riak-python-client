...
class TcpTransport(Transport, TcpConnection):
    ...
    def ping(self):
        ...
        """
        msg = Msg(riak.pb.messages.MSG_CODE_PING_REQ, None,
                  riak.pb.messages.MSG_CODE_PING_RESP)
        resp_code, _ = self._request(msg)
    ...
    def _get_client_id(self):
        ...
        msg = codec._encode_get_client_id()
        resp_code, resp = self._request(msg)
    ...
    def _set_client_id(self, client_id):
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_set_client_id(client_id)
        resp_code, resp = self._request(msg)
    ...
    def get(self, robj, r=None, pr=None, timeout=None, basic_quorum=None,
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_get(robj, r, pr,
    ...
    def put(self, robj, w=None, dw=None, pw=None, return_body=True,
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_put(robj, w, dw, pw, return_body,
    ...
    def ts_delete(self, table, key):
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_timeseries_keyreq(table, key, is_delete=True)
        resp_code, resp = self._request(msg)
        if resp is not None:
            return True
        else:
    ...
    def delete(self, robj, rw=None, r=None, w=None, dw=None, pr=None, pw=None,
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_delete(robj, rw, r, w, dw, pr, pw, timeout)
        resp_code, resp = self._request(msg)
        return self
    ...
    def stream_keys(self, bucket, timeout=None):
        ...
        msg_code = riak.pb.messages.MSG_CODE_LIST_KEYS_REQ
        codec = self._get_codec(msg_code)
        msg = codec._encode_stream_keys(bucket, timeout)
        self._send_msg(msg.msg_code, msg.data)
    ...
    def get_buckets(self, bucket_type=None, timeout=None):
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_get_buckets(bucket_type,
    ...
    def get_bucket_props(self, bucket):
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_get_bucket_props(bucket)
        resp_code, resp = self._request(msg)
    ...
    def set_bucket_props(self, bucket, props):
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_set_bucket_props(bucket, props)
        resp_code, resp = self._request(msg)
        return True
    ...
    def clear_bucket_props(self, bucket):
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_clear_bucket_props(bucket)
        self._request(msg)
        return True
    ...
    def get_bucket_type_props(self, bucket_type):
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_get_bucket_type_props(bucket_type)
        resp_code, resp = self._request(msg)
        return codec._decode_bucket_props(resp.props)
    ...
    def set_bucket_type_props(self, bucket_type, props):
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_set_bucket_type_props(bucket_type, props)
        resp_code, resp = self._request(msg)
        return True
    ...
    def stream_mapred(self, inputs, query, timeout=None):
        ...
        msg = codec._encode_stream_mapred(content)
        self._send_msg(msg.msg_code, msg.data)
    ...
    def get_index(self, bucket, index, startkey, endkey=None,
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_index_req(bucket, index, startkey, endkey,
                                      return_terms, max_results,
                                      continuation, timeout,
                                      term_regex, streaming=False)
        resp_code, resp = self._request(msg)
        return codec._decode_index_req(resp, index,
                                       return_terms, max_results)
    ...
    def create_search_index(self, index, schema=None, n_val=None,
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_create_search_index(index, schema, n_val, timeout)
        self._request(msg)
        return True
    ...
    def get_search_index(self, index):
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_get_search_index(index)
        resp_code, resp = self._request(msg)
        if len(resp.index) > 0:
    ...
    def list_search_indexes(self):
        ...
        msg_code = riak.pb.messages.MSG_CODE_YOKOZUNA_INDEX_GET_REQ
        codec = self._get_codec(msg_code)
        msg = codec._encode_list_search_indexes()
        resp_code, resp = self._request(msg)
    ...
    def delete_search_index(self, index):
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_delete_search_index(index)
        self._request(msg)
        return True
    ...
    def create_search_schema(self, schema, content):
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_create_search_schema(schema, content)
        self._request(msg)
        return True
    ...
    def get_search_schema(self, schema):
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_get_search_schema(schema)
        resp_code, resp = self._request(msg)
    ...
    def search(self, index, query, **kwargs):
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_search(index, query, **kwargs)
        resp_code, resp = self._request(msg)
    ...
    def get_counter(self, bucket, key, **kwargs):
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_get_counter(bucket, key, **kwargs)
        resp_code, resp = self._request(msg)
    ...
    def update_counter(self, bucket, key, value, **kwargs):
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_update_counter(bucket, key, value, **kwargs)
        resp_code, resp = self._request(msg)
        if resp.HasField('value'):
            return resp.value
        else:
    ...
    def fetch_datatype(self, bucket, key, **kwargs):
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_fetch_datatype(bucket, key, **kwargs)
        resp_code, resp = self._request(msg)
    ...
    def update_datatype(self, datatype, **kwargs):
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_update_datatype(datatype, **kwargs)
        resp_code, resp = self._request(msg)
    ...
    def get_preflist(self, bucket, key):
        ...
        codec = self._get_codec(msg_code)
        msg = codec._encode_get_preflist(bucket, key)
        resp_code, resp = self._request(msg)
    ...
    # TODO RTS-842 move to base Codec object
    ...
    # TODO RTS-842 is_ttb
    def _request(self, msg, is_ttb=False):
